...
third_set = {'Hello', 1, 2, 10, 20, 30, 40, 50, 123.456}

union_set = first_set | second_set | third_set
print('A set with the elements union of the original sets: ', union_set)
...
print('A set representing the elements of the first set, which are not found in the others (difference): ', difference_set)

symmetric_difference = first_set ^ second_set
print('A set with elements found in either of the two given sets, but not in both:', symmetric_difference)